...
func tenantRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_tenant"}
}

func applicationRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_application"}
}

func themeRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_theme"}
}

func keyRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_key"}
}

func lambdaRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_lambda"}
}

func emailRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_email"}
}

func formRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_form"}
}

func entityTypeRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_entity_type"}
}

func entityRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_entity"}
}

func groupRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_group"}
}

func userRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_user"}
}

func consentRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_consent"}
}

func smsTemplateRef() config.Reference {
	return config.Reference{TerraformName: "fusionauth_sms_message_template"}
}
