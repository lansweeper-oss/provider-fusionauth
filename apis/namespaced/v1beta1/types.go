...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,provider,fusionauth}
...
// +kubebuilder:resource:scope=Cluster,categories={crossplane,provider,fusionauth}
