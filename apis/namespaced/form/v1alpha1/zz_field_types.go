...
type FieldInitParameters struct {
	...
	// The Id of an existing Consent. This field will be required when the type is set to consent.
	// +crossplane:generate:reference:type=github.com/lansweeper-oss/provider-fusionauth/apis/namespaced/fusionauth/v1alpha1.Consent
	...
	ConsentIDRef *v2.NamespacedReference `json:"consentIdRef,omitempty" tf:"-"`

	// Selector for a Consent in fusionauth to populate consentId.
	// +kubebuilder:validation:Optional
	ConsentIDSelector *v2.NamespacedSelector `json:"consentIdSelector,omitempty" tf:"-"`
