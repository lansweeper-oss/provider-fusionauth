...
type ThemeInitParameters struct {
	...
	SourceThemeIDRef *v2.NamespacedReference `json:"sourceThemeIdRef,omitempty" tf:"-"`

	// Selector for a Theme in fusionauth to populate sourceThemeId.
	// +kubebuilder:validation:Optional
	SourceThemeIDSelector *v2.NamespacedSelector `json:"sourceThemeIdSelector,omitempty" tf:"-"`
