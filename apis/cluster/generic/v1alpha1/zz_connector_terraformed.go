...
func (mg *Connector) GetTerraformResourceType() string {
	return "fusionauth_generic_connector"
}

// GetConnectionDetailsMapping for this Connector
func (tr *Connector) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"http_authentication_password": "httpAuthenticationPasswordSecretRef", "http_authentication_username": "httpAuthenticationUsernameSecretRef"}
}
