...
func (mg *Tenant) GetTerraformResourceType() string {
	return "fusionauth_tenant"
}

// GetConnectionDetailsMapping for this Tenant
func (tr *Tenant) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"captcha_configuration[*].secret_key": "captchaConfiguration[*].secretKeySecretRef", "email_configuration[*].password": "emailConfiguration[*].passwordSecretRef", "email_configuration[*].properties": "emailConfiguration[*].propertiesSecretRef"}
}
